const WSSEvent = require("./websocket/serverEvents");
const {broadcastClear, broadcast, single} = require("./websocket/send");
const {
    E_QUIT,
    E_TIMER,
    E_ERROR,
...
const WSTimer = require("./websocket/timers");
...
// const wsClient = new WebSocket("ws://localhost:3000?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NTYyNWE2OWMwZDE2NTM4NDk0YzdjNjIiLCJpYXQiOjE3MDA5NDQ0ODksImV4cCI6MTcwMDk0ODA4OX0.NpdD_8cbx67nqyklmj3hRjmBkZFIRpVELn6azSuzFSI")
